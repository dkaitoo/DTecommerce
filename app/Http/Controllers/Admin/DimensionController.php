...
class DimensionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $data = Attribute::where('name','dimension')->latest()->get();
        ...
        return view('admin.attributes.dimensionProduct');
    }
    ...
    public function store(Request $request)
    {
        ...
        return response()->json([
            'status'=>200,
            'message'=>'Lưu kích thước thành công.'
        ]);
    }
    ...
    public function destroy($id)
    {
        ...
        return response()->json(['success'=>'Đã xóa kích thước này thành công.']);
    }
}
