...
<div class="messenger">
    ...
    <div class="messenger-listView">
        ...
        <div class="m-header">
            <nav>
                <a href="#"><i class="fas fa-inbox"></i> <span class="messenger-headTitle">DT CHAT</span> </a>
                {{-- header buttons --}}
...
{{--                    <span class="far fa-user"></span> Mọi người--}}
                </a>
...
{{--             </div>--}}
           ...
           <div class="messenger-tab search-tab app-scroll" data-view="search">
                ...
                <div class="search-records">
                    <p class="message-hint center-el"><span>Nhập gì đó...</span></p>
                </div>
             </div>
        </div>
    </div>
    ...
    <div class="messenger-messagingView">
            ...
            <nav class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                ...
                <nav class="m-header-right">
                    ...
                    @if(Auth::user()->role === 'seller')
                        {{--La seller--}}
                        <a href="{{route('sellerHome')}}"><i class="fas fa-home"></i></a>
                    @elseif(Auth::user()->role === 'admin')
                        <a href="{{route('dashboard')}}"><i class="fas fa-home"></i></a>
                    @else
                        <a href="{{route('home')}}"><i class="fas fa-home"></i></a>
                    @endif
                    <a href="#" class="show-infoSide"><i class="fas fa-external-link-square-alt"></i></a>
                </nav>
            </nav>
        </div>
        {{-- Internet connection --}}
        <div class="internet-connection">
            ...
            <span class="ic-noInternet">Mất kết nối</span>
        </div>
        {{-- Messaging area --}}
