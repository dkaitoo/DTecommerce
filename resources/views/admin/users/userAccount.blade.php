      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-body"  style="margin: 20px;">
            <h2 class="card-title text-success text-uppercase"> <b>Danh sách tài khoản người dùng</b></h2>
            <div class="row">
              <div class="col-md-4">
{{--                <a href="#addAccount" class="btn btn-success" data-toggle="modal"><i class="fa fa-plus-circle fa-lg" aria-hidden="true"></i> <span style="font-size: 1.2rem;">&nbsp;Tạo tài khoản mới?</span></a>--}}
              </div>
