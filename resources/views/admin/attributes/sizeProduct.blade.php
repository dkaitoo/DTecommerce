          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-body" style="margin: 20px;">
                ...
                <h3 class="card-title text-success text-uppercase"> <b>Danh sách kích cỡ</b></h3>
                <div class="row">
                  <div class="col-md-4" style="margin-bottom: 15px;">
                      <a class="btn btn-success" href="javascript:void(0)" id="createNewSize"><i class="fa fa-plus-circle fa-lg" aria-hidden="true"></i><span style="font-size: 1.2rem;">&nbsp;Tạo kích cỡ mới</span></a>
                  </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="sizeForm" name="sizeForm" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label for="size">Kích cỡ (XL,S,M,L,...)</label><br>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('body').on('click', '.editAttribute', function () {
                ...
                $.get("{{ route('size.index') }}" +'/' + attribute_id +'/edit', function (data) {
                    $('#modelHeading').html("Cập nhật kích cỡ");
                    $('#saveBtn').val("edit-size");
                    $('#ajaxModel').modal('show');
            ...
            --------------------------------------------
            --------------------------------------------*/
            $('body').on('submit', '#sizeForm', function (e) {
                e.preventDefault();
                var actionType = $('#saveBtn').val();
                $('#saveBtn').html('Đang gửi...');
                var formData = new FormData($('#sizeForm')[0]); // get form not button(this), use [0]
                $.ajax({
            ...
            $('body').on('click', '.deleteAttribute', function () {
                ...
                $.ajax({
                    type: "DELETE",
                    url: "{{ route('size.store') }}"+'/'+attribute_id,
                    success: function (response) {
                        table.draw();
                    },
                    error: function (response) {
